...
export default class OAuthUtils {
    ...
    getUserData() {
        ...
        const { name, url, urlKey, customBaseUrl } = this.userPortal;
        ...
        const baseUrl =
            this.userPortal && url && urlKey && customBaseUrl
                ? `https://${urlKey}.${customBaseUrl}`
                : url;
    ...
    isSignedIn() {
        return this.userPortal ? true : false;
    }
}
